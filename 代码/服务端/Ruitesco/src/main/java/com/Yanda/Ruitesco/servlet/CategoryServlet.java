...
//		String username = "123456";
	...
	public void GetLeaf(HttpServletRequest request, HttpServletResponse response) throws IOException {
		MessageResponse<Object> messageResponse = category_service.QueryAllLeaf();
		String json = gson.toJson(messageResponse);
		System.out.println(json);
		PrintWriter pw = response.getWriter();
		pw.write(json);
