...
public class ShippingAddrServiceImpl implements IShippingAddrService {
	...
	@Override
	public MessageType<Object> addAddress(int user_id, String receiverName, String receiverMobile,
		...
		int result = addr_dao.InsertAddress(user_id, receiverName, receiverMobile, receiverProvince, receiverDistrict, receiverCity, receiverAddress, receiverZip);
		if(result <= 0) {
			messageType = new MessageType<Object>(2, "添加失败", null);
		}
		else {
			int ship_id = addr_dao.QueryAddress(user_id, receiverName, receiverMobile, receiverProvince, receiverCity, receiverAddress, receiverZip);
			if(ship_id == 0)
	...
	@Override
	public MessageType<Object> updateAddress(int id, String name, String mobile, String province,
			String city, String district, String address, int zip) {
		// TODO Auto-generated method stub
		MessageType<Object> messageType;
		
		int result = addr_dao.UpdateAddress(id, name, mobile, province, city, district, address, zip);
		if(result <= 0) {
