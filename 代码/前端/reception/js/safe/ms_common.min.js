...
ms_common.userAvatar = function() {
	$(".useinfo-avatar").on("mouseover", function() {
		$(this).addClass("avatar-mouse-over")
	});
	$(".useinfo-avatar").on("mouseleave", function() {
...
ms_common.checkScreenSize = function() {
	...
	if (screen.width < 1240) {
		bodyClassName = a.getAttribute("className") || a.getAttribute("class");
		a.className = (bodyClassName ? bodyClassName + " " : " ") + "w990"
	}
};
ms_common.msiOnSubmitSearch = function(c) {
	var b = $("#" + c).val();
	var a = $.trim(b);
	if (a == "") {
		$("#" + c).focus();
		...
		$("#searchKeywords").val(b);
		ms_common.onSubmitSearch(b)
	}
};
ms_common.onSubmitSearch = function(c) {
	var a = sn.searchDomain.replace("emall/", "") + encodeURIComponent(ms_common.resolveStr(c));
	var b = ms_common.getCookie("cityId") || "9173";
	a += "/cityId=" + b;
	window.location.href = a;
	return false
};
ms_common.resolveStr = function(a) {
	a = a.replace(/\-/g, "%2d");
	a = a.replace(/\&/g, "%26");
	a = a.replace(/\./g, "%2E");
	a = a.replace(/\+/g, "%2B");
...
ms_common.getCookie = function(c) {
	var d;
	return (d = document.cookie.match(RegExp("(^| )" + c + "=([^;]*)(;|$)"))) ? decodeURIComponent(d[2].replace(/\+/g,
		"%20")) : null
};
ms_common.getEnv = function(d) {
	var g = "";
	var c = /^(\w*)(pre)(\w*)(.cnsuning.com)$/,
		b = /^(\w*)(sit)(\w*)(.cnsuning.com)$/,
		e = /^(\w*)(dev)(\w*)(.cnsuning.com)$/,
	...
	switch (f) {
		...
		case "pre":
			switch (d) {
				case "passportDomain":
					g = "passportpre.cnsuning.com";
					break;
				case "rxfDomain":
					g = "rxfpre.cnsuning.com";
					break;
				case "sncfDomain":
					g = "sncfcpre.cnsuning.com";
					break;
				case "shoppingDomain":
					g = "shoppingpre.cnsuning.com";
					break;
				case "msiDomain":
					g = "mypre.cnsuning.com";
					break;
				case "mmsDomain":
					g = "msgpre.cnsuning.com";
					break;
				case "domain":
					g = "b2cpre.cnsuning.com";
					break
			}
			break;
		case "sit":
			switch (d) {
				case "passportDomain":
					g = "passportsit.cnsuning.com";
					break;
				case "rxfDomain":
					g = "rxfsit.cnsuning.com";
					break;
				case "sncfDomain":
					g = "sncfcsit.cnsuning.com";
					break;
				case "shoppingDomain":
					g = "shoppingsit.cnsuning.com";
					break;
				case "msiDomain":
					g = "mysit.cnsuning.com/msi-web";
					break;
				case "mmsDomain":
					g = "msgsit.cnsuning.com";
					break;
				case "domain":
					g = "b2csit.cnsuning.com";
					break
			}
			break
	}
...
$(function() {
	...
	$("#searchKeywordFixed").on("keydown", function(a) {
		if (a.keyCode == 13) {
