...
SFE.base = function(a) {
	...
	var k = function(a) {
		...
		u = function(b) {
			var e = a(b);
			null != e && e.length > 0 && (e.on("mouseover", function() {
				c(this)
			}), e.click(function() {
				d(this)
			}))
	...
	SFE.base.toolBarEvent(), SFE.base.getActivityNav(), SFE.search.searchEvent(), SFE.base.allSort(), SFE.base.fixEvent(), SFE.base.footerLazyLoad(), $("a[name^=public0_],input[name^=public0_]").on("click", function() {
