...
public interface IShippingAddrDao {
	...
	public int QueryAddress(int user_id, String receiverName, String receiverPhone, String receiverMobile,
	...
	public int UpdateAddress(int id, String name, String phone, String mobile, String province,
